...
#criando lista para popular as caixas de "Combinação"
profissoes = ['Advogado', 'Arquiteto', 'Cientista de Dados', 'Contador','Dentista','Empresário',
...
with st.form(key='prediction_form'):
    ...
    tempo_profissao = st.number_input('Tempo de profissão(em anos): ', min_value=0, value=0, step=1)
    ...
    #Criando o botão que vai disparar a requisição da api
...
if submit_button:
    ...
    if response.status_code == 200:
        ...
        probabilidade = predictions[0][0] * 100 #Coonvertendo para porcentagem 
